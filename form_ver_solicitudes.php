...
<html lang="es">
	...
	<header>
		<nav class="navbar navbar-default" role="navigation">
			<ul class="nav nav-pills nav-justified">
				...
				<li ><a href="menu_ppal.php?codigo=0">Solicitudes</a></li>
				<li class="active"><a href="form_ver_solicitudes.php?codigo=0">Mis Solicitudes</a></li>
	...
	<body>
		...
		<form name="registro_solicitud" class="form-horizontal" method="post" role="form" action="registrar_solicitud.php" enctype="multipart/form-data">
			<div align="center">
...
if (mysqli_connect_errno()) {
    ...
    exit();
		...
		<div    class="navbar navbar-default navbar-fixed-bottom ">
			<div class="container">
			  <p>&copy2021- TaksandWorks, Celular:311 776 555, Mail:taksandworks@gmail.com </p>       
			</div>    
	    </div>
	  <style type="text/css">
	   p
