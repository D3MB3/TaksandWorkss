...
<html lang="es">
	...
	<button class="nav nav-pills"><a href="javascript:location.reload()">Confirmar Solicitud</a></button>
		<?php    
...
?>	
	<body>
		...
		<div class="panel-body">
			<?php    
                                        if ($codigo!=0)//Nuevo 5//para saber si la fundación va a realizar una solicitud, el $codigo es de la url//NUEVO5
                                           {//NUEVO5

			echo '<form name="registro_solicitud" class="form-horizontal" method="post" role="form" action="registrar_trabajo.php" enctype="multipart/form-data">
